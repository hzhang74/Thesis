---
title: "new method with covariance"
author: "Haoran Zhang"
date: '2022-11-29'
...
```{r}
CCC<-read.csv("Final_CCC.csv")
CCGG<-read.csv("Final_CCGG.csv")
