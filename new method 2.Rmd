...
```{r}
resadm<-rbind(res_adjusted_mcc,res_adjusted_mcgg)
colMeans(res_adjusted_mcc[7:42],na.rm = TRUE)
colMeans(res_adjusted_mcgg[7:42],na.rm = TRUE)
```
